...
@section('title')
    <title>Product Manage - Update Product</title>
@endsection
@section('css')
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);">
                <i style="font-size: 24px;" class="bx bx-edit-alt me-1"></i>Update Product
            </a>
        </li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="formAccountSettings" action="{{route('products.update', ['id' => $product->id])}}"
                          method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="attribute" class="select2 form-select selectAttribute">
                                    ...
                                    @foreach($attributes as $attribute)
                                        @if($attributesOfProduct[0] != null)
                                            <option
                                                {{$attribute->id == $attributesOfProduct[0]->attribute_id ? 'selected' : ''}}
                                                data-url="{{route('attributes.values', ['id' => $attribute->id])}}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select multiple="multiple" id="attribute_value"
                                        class="form-control selectAttributeValue" name="attribute_value[]">s
                                    @foreach($attribute_values as $attribute_value)
                                        @if($attributesOfProduct[0] != null)
                                            <option
                                                {{$attributesOfProduct->contains('id', $attribute_value->id) ? 'selected' : ''}}
                                                value="{{$attribute_value->id}}">{{$attribute_value->attribute_value_name}}
                                            </option>
                                        @endif
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <div class="filearray d-block">
                                    @foreach($product->images as $images)
                                        <img class="m-3" width="100px" height="100px"
                                             src="{{optional($images)->image_path}}" alt=""/>
                                    @endforeach
                                </div>
                            </div>
                            <div class="mb-3 col-md-12">
